...
temp_folder = r"\your\folder\path\here\Temp"
known_faces_folder = r"\your\folder\path\here\Known_Faces"
temp_picture = r"\your\folder\path\here\Temp\picture.jpg"
attendance_pictures = r"\your\folder\path\here\Attendance\Attendance_Pictures"
attendance = r"\your\folder\path\here\Attendance\Attendance.txt"
attendance_backup = r"\your\folder\path\here\Attendance\Attendance_Backup\Attendance.txt"
...
while True:
    ...
    cv2.imshow("Tab = Attendance,  F = New Folder,  P = New Picture in Folder,  Esc = Close", frame)
    ...
    if keyboard.is_pressed("f"):  # new personal folder in known faces folder
        ...
        # Continue asking for a folder name if it already exists
        continue
    ...
    if keyboard.is_pressed("p"):  # new picture in personal folder
        ...
        if os.path.exists(personal_folder_path):
            ...
            # Specify the path where the image will be saved
            image_path = os.path.join(personal_folder_path, f"{count}.png")
